...
//===============================================================
// Реализация SSE-интринсиков для работы с __m128_u, __m128i_u, __m128d_u
//---------------------------------------------------------------
...
// _mm_set_ss: создаёт __m128_u, устанавливая нижние 32 бита равными x, остальные – 0.
static inline __m128_u _mm_set_ss(float x) {
    __m128_u r;
    r.f[0] = x;
    r.f[1] = 0.0f;
    r.f[2] = 0.0f;
...
// _mm_castps_si128: без изменения битового представления переводит __m128_u в __m128i_u.
static inline __m128i_u _mm_castps_si128(__m128_u a) {
    __m128i_u r;
...
static inline __m128i_u _mm_cvtsi64_si128(int64_t a) {
    __m128i_u r;
    r.ll[0] = a;
    r.ll[1] = 0;
    return r;
...
// _mm_cvtsi128_si32: возвращает нижние 32 бита из __m128i_u.
static inline int _mm_cvtsi128_si32(__m128i_u a) {
    return a.i[0];
}

// _mm_set_sd: создаёт __m128d_u, устанавливая нижние 64 бита равными a, остальные – 0.0.
static inline __m128d_u _mm_set_sd(double a) {
    __m128d_u r;
    r.d[0] = a;
    r.d[1] = 0.0;
    return r;
...
// _mm_castpd_si128: без изменения битового представления переводит __m128d_u в __m128i_u.
static inline __m128i_u _mm_castpd_si128(__m128d_u a) {
    __m128i_u r;
    // Копируем 128 бит
...
// _mm_cvtsi128_si64: возвращает нижние 64 бита из __m128i_u.
static inline int64_t _mm_cvtsi128_si64(__m128i_u a) {
    return a.ll[0];
}

// _mm_cvtsi32_si128: превращает int в __m128i_u (нижние 32 бита равны a, остальные 0).
static inline __m128i_u _mm_cvtsi32_si128(int a) {
    __m128i_u r;
    r.i[0] = a;
    r.i[1] = 0;
    r.i[2] = 0;
...
// _mm_castsi128_ps: без изменения битового представления переводит __m128i_u в __m128_u.
static inline __m128_u _mm_castsi128_ps(__m128i_u a) {
    __m128_u r;
    r.f[0] = *(float*)&a.i[0];
    r.f[1] = *(float*)&a.i[1];
    r.f[2] = *(float*)&a.i[2];
...
// _mm_cvtss_f32: возвращает нижнее значение float из __m128_u.
static inline float _mm_cvtss_f32(__m128_u a) {
    return a.f[0];
}

// _mm_castsi128_pd: без изменения битового представления переводит __m128i_u в __m128d_u.
static inline __m128d_u _mm_castsi128_pd(__m128i_u a) {
    __m128d_u r;
    r.ll[0] = a.ll[0];
    r.ll[1] = a.ll[1];
    return r;
...
// _mm_cvtsd_f64: возвращает нижнее значение double из __m128d_u.
static inline double _mm_cvtsd_f64(__m128d_u a) {
    return a.d[0];
}
